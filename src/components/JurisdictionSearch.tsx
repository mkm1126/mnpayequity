...
export function JurisdictionSearch({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 mb-4">
      <h2 className="text-sm font-medium mb-3 text-gray-700">Select Jurisdiction</h2>
      ...
      <div className="relative" ref={dropdownRef}>
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#003865] focus:border-transparent text-sm"
          />
            ...
            {filteredJurisdictions.length === 0 ? (
              ...
              filteredJurisdictions.map((j) => (
                ...
                >
                  ...
                  <div className="text-xs text-gray-500">ID: {j.jurisdiction_id}</div>
                </button>
              ))
            )}
          </div>
