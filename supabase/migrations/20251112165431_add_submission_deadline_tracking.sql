/*
  ...
  1. New Fields
    - `reports.submitted_on_time` (boolean) - Indicates if report was submitted by January 31st deadline
    - `reports.submission_deadline` (date) - Stores the actual deadline date (January 31st of report year)
  ...
  3. Auto-Approval Logic
    - Reports must be submitted on or before January 31st to qualify for auto-approval
...
COMMENT ON COLUMN reports.submitted_on_time IS 'Indicates if report was submitted by January 31st deadline for auto-approval eligibility';
COMMENT ON COLUMN reports.submission_deadline IS 'The actual deadline date (January 31st of report year) for this report';
